...
use wayle_config::schemas::modules::{TriadLabelStrategy as LabelStrategy, WorkspaceStyle};
...
/// has no name set.
pub(super) fn label_for(idx: u32, name: Option<&str>, strategy: LabelStrategy) -> Option<String> {
    match strategy {
...
pub(super) fn is_ignored(name: Option<&str>, idx: u32, id: u64, patterns: &[String]) -> bool {

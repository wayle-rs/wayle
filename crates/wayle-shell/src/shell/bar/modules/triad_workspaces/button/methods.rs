//! [`TriadWorkspaceButton`] private helpers: state-driven rendering decisions.
...
use super::{TriadWorkspaceButton, TriadWorkspaceButtonInit};
use crate::shell::bar::modules::triad_workspaces::helpers;
...
pub(super) fn compute_css_classes(init: &TriadWorkspaceButtonInit) -> Vec<String> {

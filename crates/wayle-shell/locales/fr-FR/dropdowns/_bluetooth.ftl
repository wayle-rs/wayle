...
dropdown-bluetooth-paired = Apparié
...
dropdown-bluetooth-type-handheld = PC portable
dropdown-bluetooth-type-palm = Assistant numérique
dropdown-bluetooth-type-wearable-computer = Ordinateur portable sur soi
...
dropdown-bluetooth-type-smartphone = Smartphone
...
dropdown-bluetooth-type-headset = Micro-casque
...
dropdown-bluetooth-type-headphones = Casque audio
dropdown-bluetooth-type-portable-audio = Audio portable
dropdown-bluetooth-type-car-audio = Audio voiture
dropdown-bluetooth-type-set-top-box = Décodeur TV
dropdown-bluetooth-type-hifi = Audio hi-fi
...
dropdown-bluetooth-type-video-display = Affichage vidéo et haut-parleur
dropdown-bluetooth-type-video-conferencing = Visioconférence
...
dropdown-bluetooth-type-gamepad = Manette de jeu
...
dropdown-bluetooth-type-camera = Caméra
dropdown-bluetooth-type-scanner = Scanner
dropdown-bluetooth-type-printer = Imprimante

## Types d'appareils - Objet connecté
dropdown-bluetooth-type-wearable = Objet connecté
dropdown-bluetooth-type-wrist-watch = Montre bracelet
...
dropdown-bluetooth-service-lan-access = Accès LAN
dropdown-bluetooth-service-dialup-networking = Réseau commuté
dropdown-bluetooth-service-object-push = Envoi d'objets
dropdown-bluetooth-service-file-transfer = Transfert de fichiers
dropdown-bluetooth-service-headset = Audio micro-casque
dropdown-bluetooth-service-audio-source = Source audio
dropdown-bluetooth-service-audio-sink = Sortie audio
...
dropdown-bluetooth-service-phonebook = Accès répertoire
...
dropdown-bluetooth-no-devices-description = Assurez-vous que votre appareil est en mode association
...
dropdown-bluetooth-no-adapter-description = Aucun adaptateur Bluetooth détecté
dropdown-bluetooth-no-nearby = Aucun autre appareil à proximité
dropdown-bluetooth-no-new = Aucun nouvel appareil trouvé

## Appairage
dropdown-bluetooth-pairing-enter-pin = Entrez ce code PIN sur l'appareil
dropdown-bluetooth-pairing-type-on-device = Saisissez le code PIN sur l'appareil, puis appuyez sur Entrée
dropdown-bluetooth-pairing-enter-shown-pin = Entrez le code PIN affiché sur l'appareil
dropdown-bluetooth-pairing-confirm-code = Confirmez que ce code correspond à celui de l'appareil :
dropdown-bluetooth-pairing-entering = { $entered } chiffres saisis sur { $total }
dropdown-bluetooth-pairing-allow-pairing = Autoriser l'association de cet appareil ?
dropdown-bluetooth-pairing-service-allow = Autoriser cet appareil à accéder au service demandé ?
dropdown-bluetooth-pairing-enter-legacy-pin = Entrez le code PIN pour cet appareil
dropdown-bluetooth-pairing-pin-placeholder = PIN
dropdown-bluetooth-pairing-common-pins = PIN courants : 0000, 1234, 1111
dropdown-bluetooth-pairing-failed = Échec de l'association. Le PIN peut être incorrect ou la demande a expiré.

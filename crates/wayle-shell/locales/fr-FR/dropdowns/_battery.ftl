...
dropdown-battery-time-remaining = { $duration } restants
dropdown-battery-time-until-full = { $duration } jusqu'à charge complète
...
dropdown-battery-charged = Chargée
dropdown-battery-health = État

## Limite de charge
dropdown-battery-charge-limit = Limite de charge
dropdown-battery-limit-to = Limiter à { $threshold }%
dropdown-battery-resumes-at = Reprise de charge à { $threshold }%
...
dropdown-battery-profile-balanced = Équilibre
dropdown-battery-profile-performance = Performance
dropdown-battery-power-profile-not-available = Le service power-profiles-daemon doit être actif

## Pas de batterie
dropdown-battery-no-battery-title = Aucune batterie détectée
dropdown-battery-no-battery-description = Fonctionne sur secteur

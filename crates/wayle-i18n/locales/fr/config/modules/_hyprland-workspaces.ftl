...
settings-modules-hyprland-workspaces-show-special = Afficher speciaux
    .description = Inclure les espaces de travail scratchpad

settings-modules-hyprland-workspaces-urgent-show = Afficher urgents
    .description = Animation de pulsation sur les espaces de travail avec des fenêtres urgentes

settings-modules-hyprland-workspaces-display-mode = Mode affichage
    .description = Ce qui identifie chaque espace de travail (libellé, icône ou aucun)
...
settings-modules-hyprland-workspaces-workspace-ignore = Ignorer des espaces de travail
    .description = Motifs globaux pour masquer certains IDs d'espaces de travail
...
settings-modules-hyprland-workspaces-active-color = Couleur active
    .description = Couleur pour les icônes et libellés de l'espace de travail actif

settings-modules-hyprland-workspaces-occupied-color = Couleur occupee
    .description = Couleur pour les icônes et libellés des espaces de travail occupés

settings-modules-hyprland-workspaces-empty-color = Couleur vide
    .description = Couleur pour les icônes et libellés des espaces de travail vides
...
settings-modules-hyprland-workspaces-border-color = Couleur de bordure
    .description = Couleur de bordure du conteneur d'espaces de travail

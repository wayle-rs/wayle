...
settings-modules-weather-visual-crossing-key = Visual Crossing Key
    .description = Clé API pour Visual Crossing. Utilisez $VAR_NAME pour référencer les variables .env

settings-modules-weather-weatherapi-key = WeatherAPI Key
    .description = Clé API pour WeatherAPI.com. Utilisez $VAR_NAME pour référencer les variables .env

settings-modules-weather-icon-name = Icône secours
    .description = Icône affichée quand les données météo sont indisponibles

### Configuration Wayle - Module Cava
...
settings-modules-cava-style = Style
    .description = Style de rendu de la visualisation (barres, vague ou pics)
...
settings-modules-cava-internal-padding = Remplissage interne
    .description = Remplissage aux extrémités du visualiseur en rem
...
settings-modules-cava-border-color = Couleur de bordure

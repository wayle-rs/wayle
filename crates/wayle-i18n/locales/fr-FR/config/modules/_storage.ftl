### Configuration Wayle - Module Stockage

## Configuration du module Stockage

settings-modules-storage-poll-interval-ms = Intervalle de sondage
...
settings-modules-storage-border-color = Couleur de bordure
...
settings-modules-storage-middle-click = Clic milieu

...
Add it to your layout with `aurora`:
...
| `icon-name` | string | `"ld-sun-symbolic"` | Fallback icon for aurora. |
...
| Field | Type | Default | Description |
|---|---|---|---|
| `left-click` | [`ClickAction`](/config/types#click-action) | `"dropdown:aurora"` | Action on left click. |
